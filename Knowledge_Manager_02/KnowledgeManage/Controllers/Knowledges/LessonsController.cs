...
namespace KnowledgeManage.Controllers.Knowledges
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Lesson,Name_Lesson")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id_Lesson,Name_Lesson")] Lesson lesson)
        {
