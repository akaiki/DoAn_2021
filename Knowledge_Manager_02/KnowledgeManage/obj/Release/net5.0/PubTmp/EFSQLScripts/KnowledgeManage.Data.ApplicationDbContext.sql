...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210505071451_AddToDb')
BEGIN
    CREATE TABLE [Lesson] (
...
BEGIN
    CREATE TABLE [Property] (
        [Id_Property] int NOT NULL IDENTITY,
        [Link_Property] nvarchar(max) NULL,
        [Name_Property] nvarchar(max) NULL,
        [LessonId_Lesson] nvarchar(450) NULL,
        CONSTRAINT [PK_Property] PRIMARY KEY ([Id_Property]),
        CONSTRAINT [FK_Property_Lesson_LessonId_Lesson] FOREIGN KEY ([LessonId_Lesson]) REFERENCES [Lesson] ([Id_Lesson]) ON DELETE NO ACTION
    );
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20210505071451_AddToDb')
BEGIN
    CREATE INDEX [IX_Property_LessonId_Lesson] ON [Property] ([LessonId_Lesson]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20210505071451_AddToDb', N'5.0.5');
END;
GO
