#pragma checksum "C:\Users\Akaiki\source\repos\KnowledgeManage\KnowledgeManage\Views\DS_and_A\III_1.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "faf77ba804ae18f7ecd9882f419a31cbd440a6f3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"faf77ba804ae18f7ecd9882f419a31cbd440a6f3", @"/Views/DS_and_A/III_1.cshtml")]
...
int main(){
    ...
    int");
            BeginWriteAttribute("sum", " sum =", 1029, "", 1035, 0);
            EndWriteAttribute();
            WriteLiteral(" 0;\r\n    int");
            BeginWriteAttribute("count", " count =", 1047, "", 1055, 0);
            EndWriteAttribute();
            WriteLiteral(" 0;\r\n    for(int");
            BeginWriteAttribute("i", " i =", 1071, "", 1075, 0);
            EndWriteAttribute();
            WriteLiteral(" 1; i < n; i+=2){\r\n        if(arr[i] %");
            BeginWriteAttribute("2", " 2 =", 1113, "", 1117, 0);
            EndWriteAttribute();
            WriteLiteral(@"= 1){
            ++count;
            sum += arr[i];
...
int main(){
    ...
    int");
            BeginWriteAttribute("maxNum", " maxNum =", 2055, "", 2064, 0);
            EndWriteAttribute();
            WriteLiteral(" arr[0];\r\n    for(int");
            BeginWriteAttribute("i", " i =", 2085, "", 2089, 0);
            EndWriteAttribute();
...
int main(){
    ...
    //     2. In ra cac vi tri co gia");
            BeginWriteAttribute("tri", " tri =", 3111, "", 3117, 0);
            EndWriteAttribute();
            WriteLiteral(" minNum\r\n    // Luu y: Vi");
            BeginWriteAttribute("tri", " tri =", 3142, "", 3148, 0);
            EndWriteAttribute();
            WriteLiteral(" chi so + 1\r\n    \r\n    // Tim gia tri nho nhat\r\n    int");
            BeginWriteAttribute("minNum", " minNum =", 3203, "", 3212, 0);
            EndWriteAttribute();
            WriteLiteral(" arr[0];\r\n    for(int");
            BeginWriteAttribute("i", " i =", 3233, "", 3237, 0);
            EndWriteAttribute();
            WriteLiteral(" 1;i < n;++i){\r\n        if(arr[i] < minNum)");
            BeginWriteAttribute("minNum", " minNum =", 3280, "", 3289, 0);
            EndWriteAttribute();
            WriteLiteral(@" arr[i];
    }
