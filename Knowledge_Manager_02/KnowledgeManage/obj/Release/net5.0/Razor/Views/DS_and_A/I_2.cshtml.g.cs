#pragma checksum "C:\Users\Akaiki\source\repos\KnowledgeManage\KnowledgeManage\Views\DS_and_A\I_2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "99e3cb26be3226a6b799a2a1ac98d44f4a9106bd"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"99e3cb26be3226a6b799a2a1ac98d44f4a9106bd", @"/Views/DS_and_A/I_2.cshtml")]
...
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
    ...
    <div class=""container"" id=""I_2_3"">
        ...
        <div class=""container"">
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "99e3cb26be3226a6b799a2a1ac98d44f4a9106bd10273", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "99e3cb26be3226a6b799a2a1ac98d44f4a9106bd11610", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
main() {
    ...
    //Sau: array[] = {1, 7, 5, 10, 3, 9}
            ...
            <div id=""XoaMang"">
                ...
                <p>Giả sử cho array là một mảng tuyến tính có n phần tử và k là một số nguyên dương thỏa mãn k < n. Ta có giải thuật để xóa một phần tử ");
            WriteLiteral(@"có trong mảng array tại vị trí k như sau:</p>
                <div class=""card"" style=""background-color: #F1F1F1"">
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
<code>1. Bắt đầu
2. Gán biến tạm j = k
...
4. Gán");
            BeginWriteAttribute("array[j]", " array[j] =", 9188, "", 9199, 0);
            EndWriteAttribute();
            WriteLiteral(" array[j+1]\r\n5. Gán");
            BeginWriteAttribute("j", " j =", 9218, "", 9222, 0);
            EndWriteAttribute();
            WriteLiteral(" j + 1\r\n6. Gán");
            BeginWriteAttribute("n", " n =", 9236, "", 9240, 0);
            EndWriteAttribute();
            WriteLiteral(@" n - 1
7.Kết thúc</code> </pre>
                </div><br />
...
main() {
    ...
    while(j < n){");
            ...
            BeginWriteAttribute("array[]", " array[] =", 9902, "", 9912, 0);
            EndWriteAttribute();
...
2. Gá");
            WriteLiteral("n j = 0\r\n3. Lặp lại bước 4 và 5 khi j < n    \r\n4. Nếu");
            BeginWriteAttribute("array[j]", " array[j] =", 10989, "", 11000, 0);
            EndWriteAttribute();
...
main() {
    ...
    while(j < n){
        if");
            BeginWriteAttribute("(array[j]", " (array[j] =", 11548, "", 11560, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item){
            break;
        }
