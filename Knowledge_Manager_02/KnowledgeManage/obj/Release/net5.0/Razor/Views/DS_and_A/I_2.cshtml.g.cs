#pragma checksum "C:\Users\Akaiki\source\repos\KnowledgeManage\KnowledgeManage\Views\DS_and_A\I_2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7c00107247cb0e210db09e2be068d662a3fea234"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7c00107247cb0e210db09e2be068d662a3fea234", @"/Views/DS_and_A/I_2.cshtml")]
...
<style> 
    ...
    <div class=""container"" id=""I_2_1"">
        ...
        <div class=""container"">
            ...
            <p>Mảng (Array) là một trong các cấu trúc dữ liệu quan trọng nhất. Mảng có thể lưu giữ một số phần tử cố định và các phần tử này nền có cùng kiểu. Hầu hết các cấu trúc dữ liệu đều s");
            WriteLiteral(@"ử dụng mảng để triển khai giải thuật. Dưới đây là các khái niệm quan trọng liên quan tới Mảng:</p>
            <ul>
    ...
    <div class=""container"" id=""I_2_2"">
        ...
        <hr />
            ...
            <div class=""container"" id=""I_2_2_2"">
                ...
                <p>Như đã nói ở trên, t");
            WriteLiteral(@"a có thể khai báo mảng động trong quá trình chạy chương trình C là malloc và callon hoặc trong C++ là new. Ta hãy lấy ví dụ trong C:</p>
            ...
            array = (int*)malloc(sizeof(int[10]));
                ...
                <p>Hai câu lệnh trên được hiểu là khai báo một con trỏ array, trỏ đến kiểu int nhưng ngay sau đó lại gán cho nó bằng NULL, tức không trỏ dến đâu cả, Tiếp theo, <code>(int*)malloc(sizeof(int[10]))</code> tương ứng với việc cấp phát một vùng nhớ với 10 ô nhớ đầu tiên ");
            WriteLiteral(@"trỏ vào a</p>
            </div>
    </div>
    <hr />
    <div class=""container"" id=""I_2_3"">
        ...
        <div class=""container"">
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "7c00107247cb0e210db09e2be068d662a3fea23410176", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "7c00107247cb0e210db09e2be068d662a3fea23411513", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
    ...
    <div class=""container"" id=""I_2_4"">
        ...
        <div class=""container"">
            ...
            <ul>
                ...
                <li>
                    <p><a href=""#XoaMang"">Xóa:</a> X");
            WriteLiteral(@"óa một phần tử từ mảng tại chỉ mục đã cho</p>
                </li>
                <li>
...
8.Kết thúc</code> </pre>
                ...
                <div class=");
            WriteLiteral(@"""card"" style=""background-color: #F1F1F1"">
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
<code>
#include &lt; stdio.h &gt;
main() {
  ...
  ");
            ...
            BeginWriteAttribute("array[j]", " array[j] =", 9148, "", 9159, 0);
            EndWriteAttribute();
            WriteLiteral(" array[j+1]\r\n5. Gán");
            BeginWriteAttribute("j", " j =", 9178, "", 9182, 0);
            EndWriteAttribute();
            WriteLiteral(" j + 1\r\n6. Gán");
            BeginWriteAttribute("n", " n =", 9196, "", 9200, 0);
            EndWriteAttribute();
            WriteLiteral(@" n - 1
7.Kết thúc</code> </pre>
                </div><br />
...
main() {
    ...
    while(j < n){");
            ...
            BeginWriteAttribute("array[]", " array[] =", 9826, "", 9836, 0);
            EndWriteAttribute();
            WriteLiteral(" {1, 7, 5, 3, 9}\r\n    //Sau:");
            BeginWriteAttribute("array[]", " array[] =", 9864, "", 9874, 0);
            EndWriteAttribute();
...
3. Lặp lại bước 4 và 5 khi j < n    
4. Nếu");
            BeginWriteAttribute("array[j]", " array[j] =", 10810, "", 10821, 0);
            EndWriteAttribute();
...
main() {
    ...
    while(j < n){
        if");
            BeginWriteAttribute("(array[j]", " (array[j] =", 11371, "", 11383, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item){
            break;
        }
