#pragma checksum "C:\Users\Akaiki\source\repos\KnowledgeManage\KnowledgeManage\Views\DS_and_A\I_2.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "056b7b4d670c8890d6de17caeaeb0e491f4511ec"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"056b7b4d670c8890d6de17caeaeb0e491f4511ec", @"/Views/DS_and_A/I_2.cshtml")]
...
<div class=""container"" id=""I_2_1"">
    <h3>Khái niệm</h3>
    <div class=""container"">
        <p>Mảng là một chuỗi hữu hạn các phần tử có cùng kiểu dữ liệu được lưu trữ tại các vùng nhớ liên tiếp nhau, mỗi phần tử được xác định bằng một chỉ số (số thứ tự của nó trong mảng).</p>
        <p>Mảng (Array) là một trong các cấu trúc dữ liệu quan trọng nhất. Mảng có thể lưu giữ một số phần tử cố định và các phần tử này nền có cùng kiểu. Hầu hết các cấu trúc dữ liệu đều sử dụng mảng để triển kha");
            WriteLiteral(@"i giải thuật. Dưới đây là các khái niệm quan trọng liên quan tới Mảng:</p>
        <ul>
        ...
        <ul>
            <li>Truy cập phần tử với độ phức tạp là hằng số (O(1))</li>
...
<div class=""container"" id=""I_2_2"">
    ...
    <hr />
    <div class=""cont");
            WriteLiteral(@"ainer"" id=""I_2_2_1"">
        <h5>Khái niệm</h5>
        <p>Mảng động (dynamic aray) : cấp phát bộ nhớ cho mảng một cách động trong quá trình chạy chương trình trong C là malloc và calloc, trong C++ là new</p>
    ...
    <div class=""container"" id=""I_2_2_2"">
        ...
        <p>Để khai báo đến mảng động, ta sử dụng đến con trỏ, ");
            WriteLiteral(@"vì con trỏ có khả năng trỏ đến các vị trí, thay đổi linh hoạt vùng nhớ lưu giá trị thực sự, điều này đáp ứng được yêu cầu của một mảng động.</p>
...
<div class=""container"" id=""I_2_3"">
    <h3>Biểu diễn mảng</h3>
    <div class=""container"">
        <p>Mảng có thể được khai báo theo nhiều các đa dạng trong các ngôn ngữ lập trình. Để minh họa, chúng ta");
            WriteLiteral(" sử dụng phép khai báo trong ngôn ngữ C làm ví dụ:</p>\r\n        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "056b7b4d670c8890d6de17caeaeb0e491f4511ec9881", async() => {
            }
            );
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "056b7b4d670c8890d6de17caeaeb0e491f4511ec11209", async() => {
            }
            );
            __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
            __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
...
<div class=""container"" id=""I_2_4"">
    ...
    <div class=""container"">
        <p>Các hoạt động cơ bản trên mảng:</p>
        <ul>
            <li>
                <p><a href=""#DuyetMang"">Duyệt:</a> Duyệt qua các phần tử có trong mảng.</p>
            </li>
            <li>
                <p><a href=""#ChenMang"">Chèn:</a> Thêm một phần tử vào mảng tại chỉ mục đã cho</p>
            </li>
            <li>
                <p><a href=""#XoaMang"">Xóa:</a> Xóa một phần tử từ mảng tại chỉ mục đã cho</p>
            </li>
            <l");
            WriteLiteral(@"i>
                <p><a href=""#TimKiemMang"">Tìm kiếm:</a> Tìm kiếm một phần tử bởi sử dụng chỉ mục hay bởi giá trị.</p>
            </li>
            <li>
                <p><a href=""#CapNhatMang"">Cập nhật:</a> Cập nhật giá trị một phần tử tại chỉ mục nào đó.</p>
            </li>
        </ul>
        <hr />
        <div id=""DuyetMang"">
...
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
        ...
        //Giá trị của mảng tại chỉ mục thứ 2 là <span style=""color: red""><b>array[2]</b></span> có giá trị là <span style=""color: red""><b>7</b></span>
    </code> </pre>
            </div><br />
        </div>
        <hr />
        <div id=""ChenMang"">
            <p><b>Chèn:</b> Hoạt động chèn là để ch");
            WriteLiteral(@"èn một hoặc nhiều phần tử dữ liệu vào trong một mảng. Tùy theo yêu cầu, phần tử mới có thể được chèn vào vị trí đầu, vị trí cuối hoặc bất kỳ vị trí chỉ mục đã cho nào của mảng.</p>
...
main() {
    ...
    //Sau: array[] = {1, 7, 5, 10, 3, 9}
        ...
        <div id=""XoaMang"">
            ...
            <p>Giả sử cho array là một mảng tuyến tính có n phần tử và k là một số nguyên dương thỏa mãn k < n. Ta có giải thuật để xóa một phần tử có trong mảng array tại vị trí k như sau:</p>
            <div class=""card"" style=""background-color: #F1F1F1"">
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
<code>
1. Bắt đầu
2. Gán biến tạm j = k
3. Lặp lại bướ");
            WriteLiteral("c 4 và 5 khi j < n    \r\n4. Gán");
            BeginWriteAttribute("array[j]", " array[j] =", 8640, "", 8651, 0);
            EndWriteAttribute();
            WriteLiteral(" array[j+1]\r\n5. Gán");
            BeginWriteAttribute("j", " j =", 8670, "", 8674, 0);
            EndWriteAttribute();
            WriteLiteral(" j + 1\r\n6. Gán");
            BeginWriteAttribute("n", " n =", 8688, "", 8692, 0);
            EndWriteAttribute();
            WriteLiteral(@" n - 1
7.Kết thúc</code> </pre>
            </div><br />
...
main() {
    ...
    while(j < n){");
            ...
            BeginWriteAttribute("array[]", " array[] =", 9306, "", 9316, 0);
            EndWriteAttribute();
            WriteLiteral(" {1, 7, 5, 3, 9}\r\n    //Sau:");
            BeginWriteAttribute("array[]", " array[] =", 9344, "", 9354, 0);
            EndWriteAttribute();
        ...
        <div id=""TimKiemMang"">
            <p><b>Tìm kiếm:</b> Tìm kiếm một phần tử có trong mảng.Có rất nhiều giải thuật để tìm kiếm trong mảng, mỗi giải thuật có độ phức tạp khác nhau. Ở đây chúng ta sẽ sử dụng giải thuật tìm kiếm tuyến tính làm ví dụ.</p>
            <p>Giả sử ta có array là một mảng tuyến tính có n phần tử và k là số nguyên dương thỏa mãn k < n. Ta có giải thuật cho hoạt động tìm kiếm dựa theo giải thuật tìm kiếm tuyến tính: </p>
            <div class=""card"" style=""background-color: #F1F1F1"">
<pre style=""padding: 1em; margin: .5em 0; overflow: auto;"" class=""card-body"">
<code>
1. Bắt đầu
...
4. Nếu");
            BeginWriteAttribute("array[j]", " array[j] =", 10262, "", 10273, 0);
            EndWriteAttribute();
...
main() {
    ...
    while(j < n){
        if");
            BeginWriteAttribute("(array[j]", " (array[j] =", 10811, "", 10823, 0);
            EndWriteAttribute();
            WriteLiteral(@"= item){
            break;
        }
...
1. Bắt đầu
2. Thiế");
            WriteLiteral(@"t lập array[k-1] = item
3. Kết thúc</code> </pre>
            </div><br />
            <p>Để hiểu rõ hơn, ta tham khảo giải thuật tìm kiếm trên trong ngôn ngữ C:</p>
            <div class=""card"" style=""background-color: #F1F1F1"">
...
<hr />
<div class=""container"">
    <h3>Bạn có thể tham khảo các bài tập về mảng và mảng động sau:</h3>
    <ul>
        <li><a href=""III_1"">Bài tập về mảng.</a></li>
        <li><a href=""III_2"">Bài tập về mảng động.</a></li>
    </ul>
</div>");
        }
