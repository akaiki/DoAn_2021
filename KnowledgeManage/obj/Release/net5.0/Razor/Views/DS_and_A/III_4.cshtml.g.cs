#pragma checksum "C:\Users\Akaiki\source\repos\KnowledgeManage\KnowledgeManage\Views\DS_and_A\III_4.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "29c8aea928f75ef91cf864a3960c12317ea58c32"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"29c8aea928f75ef91cf864a3960c12317ea58c32", @"/Views/DS_and_A/III_4.cshtml")]
...
<pre sty");
            WriteLiteral(@"le=""overflow: auto; font-family:Consolas"" class=""card-body"">
<code>
int peek() {
   return stack[top];
}         
   ...
   if(!isempty()) {
      ...
      printf(""Ngan xep (Stack) rong.\n"");
                ...
                <div class=""card"">
                    <div class=""card-header"">
");
            WriteLiteral(@"                        <a class=""card-link"" data-toggle=""collapse"" href=""#push"">
...
int pop() {
   ...
   if(!isempty()) {
      ...
      printf(""Khong the thu thap du lieu");
            WriteLiteral(@", ngan xep (Stack) la trong.\n"");
   }
}
        ...
        <div class=""card"">
            <div class=""card-header"">
                <a class=""card-link"" data-toggle=""collapse"" href=""#Bai3"">
                    Bài 3. Sử dụng các hàm ở <b>Bài 1</b>, lần lượt chèn các ");
            WriteLiteral(@"phần tử {2, 5, 6, 1, 3, 10, 6} vào ngăn xếp. Lấy phần tử đầu ngăn xếp mà không xóa nó khỏi ngăn xếp (chỉ lấy giá trị).
                </a>
            </div>
