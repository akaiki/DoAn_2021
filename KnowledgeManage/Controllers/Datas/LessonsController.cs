...
namespace KnowledgeManage.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Lesson,Name_Lesson,Key_Lesson")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id_Lesson,Name_Lesson,Key_Lesson")] Lesson lesson)
        {
