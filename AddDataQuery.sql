-----ADD to table lesson---------------------------------------------------------------------
--INSERT INTO Lesson VALUES('I', N'Cấu trúc dữ liệu', N'ctdl, cấu trúc dữ liệu, cau truc du lieu')
--INSERT INTO Lesson VALUES('I_2', N'Cấu trúc dữ liệu mảng', N'cau truc du lieu mang, ctdl mang, ctdl mảng, cấu trúc dữ liệu mảng, array')
--INSERT INTO Lesson VALUES('I_2#I_2_2', N'Mảng động', N'cau truc du lieu mang dong, ctdl mang dong, ctdl mảng động, cấu trúc dữ liệu mảng động, dynamic array')
--INSERT INTO Lesson VALUES('I_3', N'Cấu trúc dữ liệu danh sách liên kết', N'cau truc du lieu danh sach lien ket, ctdl dslk, cấu trúc dữ liệu danh sách liên kết, linked list')
--INSERT INTO Lesson VALUES('I_3#I_3_2', N'Danh sách liên kết đơn', N'cau truc du lieu danh sach lien ket don, ctdl dslk đơn, ctdl dslk don, cấu trúc dữ liệu danh sách liên kết đơn, linked list')
--INSERT INTO Lesson VALUES('I_3#I_3_3', N'Danh sách liên kết đôi', N'cau truc du lieu danh sach lien ket doi, ctdl dslk đôi, ctdl dslk doi, cấu trúc dữ liệu danh sách liên kết đôi, linked list')
--INSERT INTO Lesson VALUES('I_3#I_3_4', N'Danh sách liên kết vòng', N'cau truc du lieu danh sach lien ket vong, ctdl dslk vòng, ctdl dslk vong, cấu trúc dữ liệu danh sách liên kết vòng, linked list')
--INSERT INTO Lesson VALUES('I_4', N'Cấu trúc dữ liệu ngăn xếp', N'cau truc du lieu ngan xep, ctdl ngan xep, ctdl ngăn xếp, cấu trúc dữ liệu ngăn xếp, stack')
--INSERT INTO Lesson VALUES('I_5', N'Cấu trúc dữ liệu hàng đợi', N'cau truc du lieu hang doi, ctdl hang doi, ctdl hàng đợi, cấu trúc dữ liệu hàng đợi, queue')
--INSERT INTO Lesson VALUES('I_6', N'Cấu trúc dữ liệu cây', N'cau truc du lieu cay, ctdl cay, ctdl cây, cấu trúc dữ liệu cây, tree')
...
--				from Lesson
--				where Lesson.Key_Lesson like @searchString
--			) as ls, Concept
